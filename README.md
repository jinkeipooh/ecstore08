...
## 目指した課題解決
	...
	事前にクレジットカードを登録できるようにすることで、決済のたびに登録しなくて済むようにしたこと
...
クレジットカード事前登録機能|クレジットカードを事前に登録し、決済の際に利用できる機能|マイページ画面からカードを登録するボタンを押下し遷移|マイページから事前登録。登録しない状態でレジに進むと登録の画面に自動遷移|4
配送先住所登録機能|配送先住所を事前に登録し、決済の際に利用できる機能|新規登録ボタンからニックネーム等を入力したのち画面遷移|新規登録ボタンから登録。ニックネームや名前などの情報を入力したのち、住所登録画面へ遷移|7
...
### クレジット事前登録機能
[![Image from Gyazo](https://i.gyazo.com/b427af9d4d42de601152f7f3d9256c82.gif)](https://gyazo.com/b427af9d4d42de601152f7f3d9256c82)
