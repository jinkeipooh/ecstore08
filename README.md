...
商品削除機能|出品した商品を削除する機能|出品した商品をそのユーザーが削除|不要になった商品を詳細画面から削除ボタンを押下することで削除する。|3
カート機能|商品をカートに追加、削除する機能|複数商品を購入する際にカートに入れてから購入できるようにするため|商品詳細画面からカートに入れるボタンを押下することでカートに商品を追加、画面左のカートボタンからカート画面に遷移。削除ボタンを押下することでカートから商品を出すことができる。|16
商品購入機能|カートに追加した商品を購入する機能|カート画面からクレジット決済画面へ遷移|カート画面からレジに進むボタンを押下し、クレジット情報を入力したのち購入するボタンを押下|6
